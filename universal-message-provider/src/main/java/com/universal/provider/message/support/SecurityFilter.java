...
import com.universal.util.HttpUtils;
...
public class SecurityFilter implements ContainerRequestFilter {
    ...
    public SecurityFilter() throws IOException {
        ...
        properties.load(classLoader.getResourceAsStream("dubbox.properties"));

        final String clientIpBlackList = properties.getProperty("http.client.ip.black.list");
        final String requestIpWhiteList = properties.getProperty("http.request.ip.white.list");
        final String logExcludeUriList = properties.getProperty("http.log.exclude.uri.list");
    ...
    public void filter(ContainerRequestContext requestContext) throws IOException {
        ...
        logger.info("IP: {}", HttpUtils.ip(httpServletRequest));
    ...
    private void validate(final HttpServletRequest httpServletRequest) throws ValidationException {
        ...
        final String requestIp = HttpUtils.ip(httpServletRequest);
